...
public class JsonUtilsTest {
    ...
    @Test
    public void parseRecipeListJSON_expectOneEntry(){
        ...
        Recipe[] recipes;
        try {
            recipes = JsonUtils.parseRecipeListJSON(pieJSON);
        } catch (IOException e) {
            fail(e.getMessage());
            return;
        }
        ...
        //THEN
        assertThat(recipes).hasLength(1);
        assert recipes != null;
        assertThat(recipes[0].getName()).matches("Nutella Pie");
        assertThat(recipes[0].getIngredients()).hasLength(9);
        assertThat(recipes[0].getIngredients()[0].measure()).matches("CUP");
        assertThat(recipes[0].getSteps()).hasLength(7);
        assertThat(recipes[0].getSteps()[0].shortDescription()).matches("Recipe Introduction");
        assertThat(recipes[0].getServings()).isEqualTo(8);
    }
