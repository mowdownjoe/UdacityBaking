...
public class SingleRecipeCacheWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        CharSequence widgetText = SingleRecipeCacheWidgetConfigureActivity.loadTitlePref(context, appWidgetId);
    ...
    public void onDeleted(Context context, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            SingleRecipeCacheWidgetConfigureActivity.deleteTitlePref(context, appWidgetId);
        }
    }
